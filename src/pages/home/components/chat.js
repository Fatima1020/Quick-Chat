    ...
    {selectedChat && <div className="app-chat-area">
      ...
      <div className="main-chat-area" id="main-chat-area">
        {allMessages.map((msg) => {
          ...
          return <div key={msg._id} className="message-container" style={{ justifyContent: isSender ? "flex-end" : "flex-start" }}>
            <div>
              ...
              <div className="message-timestamp"
                style={{
                  ...
                  marginRight: isSender ? "-20px" : "0",
                }}
              >
                {formatTime(msg.createdAt)} {isSender && msg?.read &&
